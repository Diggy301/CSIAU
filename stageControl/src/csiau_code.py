...
class Robot:
	...
	def get_waypoint_from_circlemove(self):
		...
		# do same for min circlemove_values and check colinearity and adjust??
...
# TODO: waypoint initial cant be 0,0 -> needs to be randoml genenerated (?)
